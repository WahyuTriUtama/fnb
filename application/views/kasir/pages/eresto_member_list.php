...
<section class="content-header">
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo site_url('kasir/member');?>" title="<?php echo $title;?>"><?php echo $title;?></a></li>
        </ol>
    </div>
</section>
        ...
        <table class="table table-bordered table-striped" id="mytable">
    	    ...
    	    <tbody>
                ...
                foreach ($member_data as $member)
                {
                    ...
                    <tr>
            		    <td>
                            <a href="<?php echo site_url('kasir/member_read/'.$member->id_member) ?>" target="_self">
            		    ...
            		    <td>
                            <?php 
                            echo anchor(site_url('kasir/member_read/'.$member->id_member),'<i class="glyphicon glyphicon-search" title="View"></i>'); 
                            ?>
                        </td>
    	           </tr>
                <?php
