...
<section class="content-header">
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo site_url('kasir/menu');?>" title="<?php echo $title;?>"><?php echo $title;?></a></li>
        </ol>
    </div>
</section>
    ...
    <div class="col-lg-12">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url('kasir/menu_read/'.$menu->id_menu) ?>" target="_self">
        	    ...
        	    <td>
            		<?php 
                    echo anchor(site_url('kasir/menu_read/'.$menu->id_menu),'<i class="glyphicon glyphicon-search" title="View"></i>'); 
                    ?>
        	    </td>
            </tr>
             <?php } ?>
