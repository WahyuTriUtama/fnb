...
<section class="content-header">
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo site_url('pemesanan/meja');?>" title="<?php echo $title;?>"><?php echo $title;?></a></li>
        </ol>
    </div>
</section>
        ...
        <table class="table table-bordered table-striped" id="mytable">
    	    ...
    	    <tbody>
                ...
                <tr>
        		    ...
        		    <td>
                        <?php 
                        echo anchor(site_url('pemesanan/meja_read/'.$meja->no_meja),'<i class="glyphicon glyphicon-search" title="View"></i>'); 
                        ?>
                    </td>
               </tr>
                <?php
