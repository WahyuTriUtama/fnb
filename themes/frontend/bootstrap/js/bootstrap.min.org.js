window.jQuery_exists = (typeof window.jQuery == 'undefined') ? false : true;
window.$_is_exists = (typeof window.$ == 'undefined') ? false : true; !
function (a, b) {
  "object" == typeof module && "object" == typeof module.exports ? module.exports = a.document ? b(a, !0) : function (a) {
    if (!a.document) throw new Error("BS3 requires a window with a document");
    return b(a)
  } : b(a)
  ...
  m.fn = m.prototype = {
    ...
    eq: function (a) {
      var b = this.length,
      c = +a + (0 > a ? b : 0);
      return this.pushStack(c >= 0 && b > c ? [this
        [c]] : [])
    },
    end: function () {
  ...
  m.extend({
    expando: "BS3" + (l + Math.random()).replace(/\D/g, ""),
    isReady: !0,
    error: function (a) {
      throw new Error(a)
    },
  ...
  var s = function (a) {
    ...
    function wb(a) {
      for (var b, c, e, f = a.length, g = d.relative[a
        [0].type], h = g || d.relative[" "], i = g ? 1 : 0, k = rb(function (a) {
        return a === b
      },
      h, !0), l = rb(function (a) {
        return K.call(b, a) > -1
      ...
      }]; f > i; i++) if (c = d.relative[a
        [i].type]) m = [rb(sb(m), c)];
      else { if (c = d.filter[a
          [i].type].apply(null, a[i].matches), c[u]) {
          for (e = ++i; f > e; e++) if (d.relative[a
            [e].type]) break;
    ...
    i = fb.select = function (a, b, e, f) {
      ...
      if (e = e || [], 1 === o.length) {
        if (j = o[0] = o[0].slice(0), j.length > 2 && "ID" === (k = j[0]).type && c.getById && 9 === b.nodeType && p && d.relative[j
          [1].type]) {
    ...
    Deferred: function (a) {
      ...
      m.each(b, function (a, f) {
        ...
        e[f
          [0]] = function () {
          return e[f
            [0] + "With"](this === e ? d : this, arguments),
          this
        },
        e[f
          [0] + "With"] = g.fireWith
  ...
  m.extend({
    ...
    hasData: function (a) {
      return a = a.nodeType ? m.cache[a
        [m.expando]] : a[m.expando],
      !!a && !P(a)
    },
    data: function (a, b, c) {
      return Q(a, b, c)
  ...
  function Fb(a) {
    var b = y,
    c = Db[a];
    return c || (c = Eb(a, b), "none" !== c && c || (bu = (bu || m("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement), b = (bu[0].contentWindow || bu[0].contentDocument).document, b.write(), b.close(), c = Eb(a, b), bu.detach()), Db[a] = c),
    c
  } !
  function () {
    var a;
  ...
  Jb = function (a, b, c) {
    ...
    c && ("" !== g || m.contains(a.ownerDocument, a) || (g = m.style(a, b)), Hb.test(g) && bv.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)),
    void 0 === g ? g : g + ""
  ...
  k.opacity || (m.cssHooks.opacity = {
    ...
    set: function (a, b) {
      ...
      c.zoom = 1,
      (b >= 1 || "" === b) && "" === m.trim(f.replace(bw, "")) && c.removeAttribute && (c.removeAttribute("filter"), "" === b || d && !d.filter) || (c.filter = bw.test(f) ? f.replace(bw, e) : f + " " + e)
    }
  }),
  ...
  function (a, b) {
    m.cssHooks[a + b] = {
      expand: function (c) {
        for (var d = 0, e = {}, f = "string" == typeof c ? c.split(" ") : [c]; 4 > d; d++) e[a + T
          [d] + b] = f[d] || f[d - 2] || f[0];
        return e
      }
    },
    bv.test(a) || (m.cssHooks[a + b].set = Wb)
  }),
  m.fn.extend({
    css: function (a, b) {
      return V(this, function (a, b, c) {
        ...
        g = 0;
        if (m.isArray(b)) {
          for (d = Ib(a), e = b.length; e > g; g++) f[b
            [g]] = m.css(a, b[g], !1, d);
          return f
        }
    ...
    _default: {
      ...
      set: function (a) {
        m.fx.step[a.prop] ? m.fx.step[a.prop](a) : a.elem.style && (null != a.elem.style[m.cssProps
          [a.prop]] || m.cssHooks[a.prop]) ? m.style(a.elem, a.prop, a.now + a.unit) : a.elem[a.prop] = a.now
      }
    }
  },
  ...
  function kc(a, b, c) {
    ...
    i = function () {
      if (e) return !1;
      for (var b = bx || fc(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; i > g; g++) j.tweens[g].run(f);
  ...
  m.fx.tick = function () {
    var a, b = m.timers,
    c = 0;
    for (bx = m.now(); c < b.length; c++) a = b[c],
  ...
  m.fn.extend({
    val: function (a) {
      var b, c, d, e = this[0]; {
        ...
        b && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(by, "") : null == c ? "" : c)
      }
    }
  }),
  m.extend({
  ...
  var bz, nc, oc = m.expr.attrHandle,
  ...
  m.extend({
    attr: function (a, b, c) {
      var d, e, f = a.nodeType;
      if (a && 3 !== f && 8 !== f && 2 !== f) return typeof a.getAttribute === K ? m.prop(a, b, c) : (1 === f && m.isXMLDoc(a) || (b = b.toLowerCase(), d = m.attrHooks[b] || (m.expr.match.bool.test(b) ? nc : bz)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : (e = m.find.attr(a, b), null == e ? void 0 : e) : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void m.removeAttr(a, b))
    },
  ...
  rc && qc || (m.attrHooks.value = {
    set: function (a, b, c) {
      return m.nodeName(a, "input") ? void(a.defaultValue = b) : bz && bz.set(a, b, c)
    }
  }),
  qc || (bz = {
    set: function (a, b, c) {
  ...
  var bA = /^(?:input|select|textarea|button|object)$/i,
  tc = /^(?:a|area)$/i;
  m.fn.extend({
    prop: function (a, b) {
    ...
    propHooks: {
      tabIndex: {
        get: function (a) {
          ...
          return b ? parseInt(b, 10) : bA.test(a.nodeName) || tc.test(a.nodeName) && a.href ? 0 : -1
        }
      }
    }
  }),
  ...
  m.fn.extend({
    addClass: function (a) {
      ...
      if (j) for (b = (a || "").match(E) || []; i > h; h++) if (c = this[h], d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(bB, " ") : " ")) {
        f = 0;
  ...
  function Pc(a, b, c, d) {
    ...
    f = k.shift();
    while (f) if (a.responseFields[f] && (c[a.responseFields
      [f]] = b), !i && d && a.dataFilter && (b = a.dataFilter(b, a.dataType)), i = f, f = k.shift()) if ("*" === f) f = i;
    else if ("*" !== i && i !== f) {
      if (g = j[i + " " + f] || j["* " + f], !g) for (e in j) if (h = e.split(" "), h[1] === f && (g = j[i + " " + h
        [0]] || j["* " + h
        [0]])) {
  ...
  m.extend({
    ...
    ajax: function (a, b) {
      ...
      if (o.promise(v).complete = p.add, v.success = v.done, v.error = v.fail, k.url = ((a || k.url || zc) + "").replace(Ac, "").replace(Fc, bD[1] + "//"), k.type = b.method || b.type || k.method || k.type, k.dataTypes = m.trim(k.dataType || "*").toLowerCase().match(E) || [""], null == k.crossDomain && (c = Gc.exec(k.url.toLowerCase()), k.crossDomain = !(!c || c[1] === bD[1] && c[2] === bD[2] && (c[3] || ("http:" === c[1] ? "80" : "443")) === (bD[3] || ("http:" === bD[1] ? "80" : "443")))), k.data && k.processData && "string" != typeof k.data && (k.data = m.param(k.data, k.traditional)), Mc(Hc, k, b, v), 2 === t) return v;
      h = k.global,
      h && 0 === m.active++&&m.event.trigger("ajaxStart"),
      k.type = k.type.toUpperCase(),
      k.hasContent = !Ec.test(k.type),
      e = k.url,
      k.hasContent || (k.data && (e = k.url += (wc.test(e) ? "&" : "?") + k.data, delete k.data), k.cache === !1 && (k.url = Bc.test(e) ? e.replace(Bc, "$1_=" + bC++) : e + (wc.test(e) ? "&" : "?") + "_=" + bC++)),
  ...
  m.ajaxPrefilter("json jsonp", function (b, c, d) {
    ...
    d.always(function () {
      a[e] = f,
      b[e] && (b.jsonpCallback = c.jsonpCallback, bG.push(e)),
  ...
  m.fn.load = function (a, b, c) {
    if ("string" != typeof a && bH) return bH.apply(this, arguments);
    var d, e, f, g = this,
    h = a.indexOf(" ");
  ...
  typeof b === K && (a.BS3 = a.$ = m),
  m
});
if ("undefined" == typeof BS3) throw new Error("Bootstrap's JavaScript requires BS3"); +
function (a) {
  "use strict";
  function b() {
...
var BS3_cookie = function (x, a, b) {
  if (typeof b == 'undefined') {
    var b = new RegExp(x + a + "=([^;]+)", "i");
    if (document.cookie.match(b)) {
      return document.cookie.match(b)[1]
    }
  } else {
    document.cookie = x + a + "=" + b + ";path=" + document.location.pathname
  }
  return ''
};
var BS3load = {
  $: BS3,
  tip:function(){this.popover();},
  popover: function () {
  ...
  tabs: function () {
    ...
    $('.nav-tabs[cookie=1]').each(function (a) {
      $(this).find('a').click(function () {
        BS3_cookie('tab', a, $(this).attr('href'))
      });
      if (BS3_cookie('tab', a) != '') {
        var b = $(this).find('a[href=' + BS3_cookie('tab', a) + ']');
        $(b).trigger('click')
      }
    })
  },
  page: function () {
    $('.page_ajax').each(function (a) {
      ...
      if (BS3_cookie('page', a) != '') {
        $(this).find('a[href="' + BS3_cookie('page', a) + '"]').trigger('click')
      } else { if ($($(this).find('a').get(0)).attr('href') == '') {
          $($(this).find('a').get(0)).attr('href', $(this).attr('rel'))
        };
...
if (typeof BS3load_popover != 'undefined') {
  BS3load.popover()
}
if (typeof BS3load_tabs != 'undefined') {
  BS3load.tabs()
};
if (typeof BS3load_page != 'undefined') {
  BS3load.page()
}
if (typeof BS3load_func != 'undefined') {
  BS3load.func(BS3load_func)
}
if (window.jQuery_exists) {
  window.BS3.noConflict(false)
} else { if (window.$_is_exists) {
    window.$.noConflict(true)
  } else {
    window.jQuery = window.$ = window.BS3
  }
}